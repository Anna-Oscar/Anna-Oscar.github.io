...
![](https://img.shields.io/github/languages/top/github-Anna/VBlog.svg?style=flat)
![](https://img.shields.io/github/stars/gitHub-Anna/VBlog.svg?style=social)
...
## 快速使用
搭建博客只需2步
- 点击github头像旁边的 "+" 号 选择 ```Import repository ```克隆地址填 ```https://github.com/Anna-Oscar/Anna-Oscar.github.io ```项目名填 ```你的用户名.github.io ```
- 克隆完成后 修改文件 ```/static/configuration.json``` 中的 ```githubUsername``` 为自己的github用户名


类似演示地址其中 GitHub-Anna 为我的用户名


现在 ```https://你的用户名.github.io``` 就是你的个人博客了,例如[https://github-Anna-Oscar.github.io][1]
